        ...
        <ol className="relative mt-16 grid gap-8 lg:grid-cols-5 lg:gap-5">
          {phases.map((phase, i) => (
            ...
            >
              ...
              <span className="gold-gradient relative z-10 absolute left-0 top-0 inline-flex size-11 items-center justify-center rounded-lg font-display text-base font-bold text-gold-foreground shadow-lg shadow-black/25 lg:static lg:mb-5">
