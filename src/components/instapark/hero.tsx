...
function HeroMockup() {
  return (
    <div className="relative mx-auto max-w-md lg:max-w-none">
      ...
      <div className="relative z-10 -mt-4 ml-auto w-24 overflow-hidden rounded-[1.1rem] border-2 border-gold/40 bg-brand-deep shadow-2xl shadow-black/50 sm:w-28 lg:absolute lg:-bottom-6 lg:right-8 lg:mt-0 lg:w-32 lg:rotate-[2deg] lg:transition-all lg:duration-500 lg:hover:-translate-y-2 lg:hover:rotate-[0deg]">
        <img
